...
// @version      4.1.0
// @description  Unified YouTube optimizer: CPU/GPU/UI optimizations + automatic quality control + premium playback
...
(()=>{
  ...
  const CFG={
    ...
    flags:{
      IS_TABLET:1,DISABLE_YT_IMG_DELAY_LOADING:1,polymer_verifiy_app_state:0,
      desktop_delay_player_resizing:0,web_animated_actions:0,web_animated_like:0,
      web_animated_like_lazy_load:0,web_animated_actions_v2:0,
      render_unicode_emojis_as_small_images:1,smartimation_background:0,
      kevlar_refresh_on_theme_change:0,kevlar_measure_ambient_mode_idle:0,
      kevlar_watch_cinematics_invisible:0,web_cinematic_theater_mode:0,
      web_cinematic_fullscreen:0,enable_cinematic_blur_desktop_loading:0,
      kevlar_watch_cinematics:0,web_cinematic_masthead:0,
      web_watch_cinematics_preferred_reduced_motion_default_disabled:0,
      kevlar_tuner_should_reuse_components:1,kevlar_tuner_should_test_reuse_components:1
    }
  };
  ...
  (()=>{
    ...
    css+="ytd-item-section-renderer.style-scope.ytd-section-list-renderer[page-subtype=\"playlist\"]>#header.ytd-item-section-renderer>ytd-feed-filter-chip-bar-renderer,div#chip-bar.style-scope.ytd-search-header-renderer>yt-chip-cloud-renderer.style-scope.ytd-search-header-renderer>div#container.style-scope.yt-chip-cloud-renderer,ytd-action-companion-ad-renderer,ytd-display-ad-renderer,ytd-video-masthead-ad-advertiser-info-renderer,ytd-video-masthead-ad-primary-video-renderer,ytd-in-feed-ad-layout-renderer,ytd-ad-slot-renderer,yt-about-this-ad-renderer,yt-mealbar-promo-renderer,ytd-ad-slot-renderer,ytd-in-feed-ad-layout-renderer,.ytd-video-masthead-ad-v3-renderer,div#root.style-scope.ytd-display-ad-renderer.yt-simple-endpoint,div#sparkles-container.style-scope.ytd-promoted-sparkles-web-renderer,div#main-container.style-scope.ytd-promoted-video-renderer,div#player-ads.style-scope.ytd-watch-flexy,ad-slot-renderer,ytm-promoted-sparkles-web-renderer,masthead-ad,#masthead-ad,ytd-video-quality-promo-renderer{display:none!important}";
    if(css){
  ...
  log("YouTube Unified Optimizer v4.1.0 loaded");
})();
